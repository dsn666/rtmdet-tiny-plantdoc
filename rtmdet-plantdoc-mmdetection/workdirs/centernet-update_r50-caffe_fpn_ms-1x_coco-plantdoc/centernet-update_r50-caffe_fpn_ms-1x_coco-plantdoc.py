...
default_hooks = dict(
    ...
    visualization=dict(
        draw=True, test_out_dir='centernet', type='DetVisualizationHook'))
default_scope = 'mmdet'
env_cfg = dict(
...
launcher = 'none'
load_from = 'work_dirs/centernet-update_r50-caffe_fpn_ms-1x_coco-plantdoc/best_coco_bbox_mAP_epoch_47.pth'
log_level = 'INFO'
...
work_dir = './work_dirs/centernet-update_r50-caffe_fpn_ms-1x_coco-plantdoc'
