...
default_hooks = dict(
    ...
    visualization=dict(
        draw=True, test_out_dir='vfnet', type='DetVisualizationHook'))
default_scope = 'mmdet'
env_cfg = dict(
...
launcher = 'none'
load_from = 'work_dirs/vfnet_r50_fpn_1x_coco-plantdoc/best_coco_bbox_mAP_epoch_36.pth'
log_level = 'INFO'
...
work_dir = './work_dirs/vfnet_r50_fpn_1x_coco-plantdoc'
