...
default_hooks = dict(
    ...
    visualization=dict(
        draw=True, test_out_dir='fcos', type='DetVisualizationHook'))
default_scope = 'mmdet'
env_cfg = dict(
...
launcher = 'none'
load_from = 'work_dirs/fcos_r50-caffe_fpn_gn-head_1x_coco-plantdoc/best_coco_bbox_mAP_epoch_41.pth'
log_level = 'INFO'
...
work_dir = './work_dirs/fcos_r50-caffe_fpn_gn-head_1x_coco-plantdoc'
