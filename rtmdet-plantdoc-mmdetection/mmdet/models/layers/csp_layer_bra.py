...
class CSPLayerBRA(BaseModule):
    ...
    def __init__(self,
        ...
        self.bra_attention = bra_attention
        ...
        if bra_attention:
            ...
            self.attention = BiLevelRoutingAttention_nchw(2 * mid_channels)
