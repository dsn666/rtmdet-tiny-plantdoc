...
class CSPLayerMHRSA(BaseModule):
    ...
    def __init__(self,
        ...
        self.mhrsa_attention = mhrsa_attention
        ...
        if mhrsa_attention:
            ...
            self.attention = MHRSA(2 * mid_channels)
